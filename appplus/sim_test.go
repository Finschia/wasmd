...
//	}()
//
//	encConf := wasmapp.MakeEncodingConfig()
//	app := NewWasmApp(logger, db, nil, true, map[int64]bool{}, dir, simapp.FlagPeriodValue, encConf, wasmplustypes.EnableAllProposals, wasmapp.EmptyBaseAppOptions{}, nil, fauxMerkleModeOpt)
...
//	}()
//	newApp := NewWasmApp(logger, newDB, nil, true, map[int64]bool{}, newDir, simapp.FlagPeriodValue, encConf, wasmplustypes.EnableAllProposals, wasmapp.EmptyBaseAppOptions{}, nil, fauxMerkleModeOpt)
...
//
//	normalizeContractInfo := func(ctx sdk.Context, app *WasmPlusApp) {
//		var index uint64
