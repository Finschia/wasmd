...
func NewWasmApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		feegrant.StoreKey, authzkeeper.StoreKey, wasmplustypes.StoreKey, icahosttypes.StoreKey, icacontrollertypes.StoreKey, ibcfeetypes.StoreKey,
	)
	...
	ibcRouter.
		...
		AddRoute(wasmplustypes.ModuleName, wasmStack).
