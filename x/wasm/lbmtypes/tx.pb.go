...
import (
	...
	github_com_line_lbm_sdk_x_wasm_types "github.com/line/wasmd/x/wasm/types"
...
type MsgStoreCodeAndInstantiateContract struct {
	...
	Msg github_com_line_lbm_sdk_x_wasm_types.RawContractMessage `protobuf:"bytes,8,opt,name=msg,proto3,casttype=github.com/line/wasmd/x/wasm/types.RawContractMessage" json:"msg,omitempty"`
